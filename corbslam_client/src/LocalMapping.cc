...
namespace ORB_SLAM2 {
    ...
    LocalMapping::LocalMapping(Cache *pCacher, const float bMonocular) :
        ...
        while (1) {
            ...
            if (CheckNewKeyFrames()) {
                ...
                if (!CheckNewKeyFrames() && !stopRequested()) {
                    // Local BA
                    if (mpCacher->getKeyFramesInMap() > 2)
                        //TODO:replace the mpMap to cache
                        Optimizer::LocalBundleAdjustment(mpCurrentKeyFrame, &mbAbortBA, mpCacher);
    ...
    void LocalMapping::ProcessNewKeyFrame() {
        ...
        mpCacher->AddKeyFrameToMap(mpCurrentKeyFrame);
    ...
    void LocalMapping::CreateNewMapPoints() {
        ...
        for (size_t i = 0; i < vpNeighKFs.size(); i++) {
            ...
            for (int ikp = 0; ikp < nmatches; ikp++) {
                ...
                MapPoint *pMP = new MapPoint(x3D, mpCurrentKeyFrame, mpCacher);
